...
import { faEnvelope as Mail, faPhone, faPhoneAlt, faPhoneSlash, faPhoneSquare } from "@fortawesome/free-solid-svg-icons"; 
import "./footer.css";
      ...
      <div className="footer-container bg-gradient-to-b from-teal-900 to-zinc-950  border-indigo-300">
        ...
        <div className="footer-right text-end  col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
          <div className="footer-icons">
            ...
            <a href="mailto:teamtri2champ@gmail.com" className="social-icons ">
          ...
          <div className="footer-links ">
            ...
            <FontAwesomeIcon icon={faPhone} className="pr-2" />Call Us
            </a>
          </div>
        </div>
      </div>
